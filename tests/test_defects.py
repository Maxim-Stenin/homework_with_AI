...
что сдаётся. Каждый тест сослан на номер BUG-NNN из full-run/bugs.md и на пункт SPEC.md.
...
# а не объекта — пустая дата отклоняется корректно. Разбор — в full-run/bugs.md, пометка к BUG-006.
